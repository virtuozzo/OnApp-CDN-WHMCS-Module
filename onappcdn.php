...
if( ! defined( 'ONAPPCDN_FILE_NAME' ) ) {
	define( 'ONAPPCDN_FILE_NAME', basename( __FILE__ ) );
}
if( ! defined( 'ONAPPCDN_DIR' ) ) {
	define( 'ONAPPCDN_DIR', ROOTPATH . DS . 'modules' . DS . 'servers' . DS . 'onappcdn' . DS );
}
